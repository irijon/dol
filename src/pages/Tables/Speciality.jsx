        ...
        <>
            ...
            >
                <Modal.Content>
                    <Modal.Description>
                        <Form>
                            <Form.Field><label>Направление</label><Input onChange={(e, data) => { onChangeModalForm(['NameSpeciality'], [data.value]) }} value={modalValues.NameSpeciality||''} /></Form.Field>
                            <Form.Field><label>Профиль</label><Input onChange={(e, data) => { onChangeModalForm(['Profile'], [data.value]) }} value={modalValues.Profile||''} /></Form.Field>
                        </Form>
                    </Modal.Description>
                </Modal.Content>
                <Modal.Actions>
